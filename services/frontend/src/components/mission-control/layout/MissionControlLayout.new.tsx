/**
 * MissionControlLayout - Refactored to use compound layout components
 *
 * This is the new simplified layout (~250 lines vs original ~1,470 lines).
 * Uses WorkspaceProvider for shared state and compound components for UI.
 *
 * Phase 3 of the frontend overhaul plan.
 */
