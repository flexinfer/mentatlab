...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-[0_0_15px_rgba(124,58,237,0.5)] border border-primary/20",
        destructive:
        ...
        glow: "bg-primary text-primary-foreground shadow-[0_0_10px_rgba(124,58,237,0.5)] hover:shadow-[0_0_20px_rgba(124,58,237,0.8)] border border-primary/50",
      },
      size: {
