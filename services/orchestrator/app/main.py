...
from services.gateway.app.models import Flow, Node, Edge
...
if __name__ == "__main__":
    # This is a simple example usage for testing purposes.
    # In a real scenario, a Flow object would be loaded from a file or API.
    from datetime import datetime
    from services.gateway.app.models import Meta, Graph, Position

    # Example Flow: A -> B, A -> C, B -> D, C -> D
    # Expected topological sort: A, B, C, D (order of B, C might vary)
    ...
    try:
        ...
        # Expected output: something like ['A', 'B', 'C', 'D'] or ['A', 'C', 'B', 'D']
    except ValueError as e:
        print(f"Error generating plan: {e}")

    # Example Flow with a cycle: A -> B -> C -> A
