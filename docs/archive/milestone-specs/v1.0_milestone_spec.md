...
> **Archived / Aspirational** — This spec describes WASM runtime and PKI signing features
> that have no implementation. It is retained for reference only. The active plan is
> [.loom/30-implementation-plan.md](../.loom/30-implementation-plan.md) and
